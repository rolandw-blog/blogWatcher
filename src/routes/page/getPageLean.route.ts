...
class GetPageRouteLean implements Route {
	public path = "/page/lean/:id";
	...
	private initializeRoutes() {
		this.router.get(`${this.path}`, [...this.middleware()], this.controller.getPageLean);
	}
}

export default GetPageRouteLean;
